...
def build_alignment_report(root: Path = ROOT) -> dict[str, Any]:
    ...
    # M0 保留概念性裁决；M1–M5 则必须调度每一条 recipe，保证概念与功能
    # 证据链都能在正式执行面中获得覆盖。
    ...
    return {
        "summary": {
            ...
            "m1_m5_scheduled_clause_count": len(functional_module_clauses),
        ...
        "unexpected": {
            ...
            "m1_m5_schedule": sorted(functional_module_clauses - catalog_clauses),
            "phase": {

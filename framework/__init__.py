...
try:
    ...
    _HAS_SNAPSHOT_STORE = True
except ImportError:
    SnapshotStore = None  # type: ignore
    compute_input_digest = None  # type: ignore
    digest_file = None  # type: ignore
    digest_value = None  # type: ignore
    _HAS_SNAPSHOT_STORE = False

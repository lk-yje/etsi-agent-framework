...
| **M4 更新与完整性** | 5.3-1, 5.3-2, 5.3-3, 5.3-4, 5.3-5, 5.3-6, 5.3-7, 5.3-8, 5.3-9, 5.3-10, 5.3-11, 5.3-12, 5.3-13, 5.3-14, 5.3-15, 5.3-16, 5.4-1~4, 5.7-1, 5.7-2 | IXIT 6/7/8/10 + Burp HTTP/WS history（5.3-2/5.3-9 固件上传流量） | IXIT 分析 + Burp MCP |
  ...
  "evidence": [
    {
      ...
      "path": "nmap_tcp.txt",
      "level": "L1",
      "description": "nmap -sS -sV --top-ports 2000 192.0.2.26: 开放端口 80/443/554/8000/8443",
...
python -c "
import json
with open('C:/Users/<user>/.claude/skills/etsi-ts103701-report/references/harness-config.json') as f:
    h = json.load(f)
...
python -c "
import json
with open('C:/Users/<user>/.claude/skills/path-mapping.json') as f:
    pm = json.load(f)
p = pm['paths']
tools = [
    ('nmap', 'TOOL.NMAP'),
...
python -c "
import json
with open('C:/Users/<user>/.claude/skills/etsi-ts103701-report/references/evidence-schema.json') as f:
    s = json.load(f)
